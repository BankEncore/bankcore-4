...
curl -sS -X POST "http://localhost:3000/teller/operational_events" \
  ...
  -d '{"operational_event":{"event_type":"check.deposit.accepted","channel":"teller","idempotency_key":"chk-demo-1","amount_minor_units":500,"currency":"USD","source_account_id":YOUR_ACCOUNT_ID,"payload":{"items":[{"amount_minor_units":500,"item_reference":"MICR-DEMO"}]},"hold_amount_minor_units":500,"hold_idempotency_key":"chk-demo-1-hold"}}'
```
