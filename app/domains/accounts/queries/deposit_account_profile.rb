    ...
    class DepositAccountProfile
      ...
      def self.call(deposit_account_id:)
        ...
        Result.new(
          ...
          active_restrictions: account.account_restrictions.active.order(:effective_on, :id).to_a,
          restriction_history: account.account_restrictions.order(effective_on: :desc, id: :desc).to_a,
          lifecycle_events: account.account_lifecycle_events.order(effective_on: :desc, id: :desc).to_a,
