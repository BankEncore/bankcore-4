...
module Core
  module Posting
    module PostingRules
      # GL 1160 / 2110 per ADR-0040; liability leg tagged with deposit subledger.
      module CheckDepositAccepted
        module_function
        ...
        def legs_for(event)
          ...
          if event.source_account_id.blank?
            raise Core::Posting::Commands::PostEvent::InvalidState,
                  "source_account_id required for check.deposit.accepted"
          end

          [
            PostingLeg.new(
              sequence_no: 1,
              gl_account_number: "1160",
              side: "debit",
