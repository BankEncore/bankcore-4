...
module Core
  module Posting
    module PostingRules
      # Pays accrued deposit interest into DDA liability (ADR-0021).
      module InterestPosted
        module_function
        ...
        def legs_for(event)
          ...
          if event.source_account_id.blank?
            raise Core::Posting::Commands::PostEvent::InvalidState, "source_account_id required for interest.posted"
          end
